...
public class AddRestaurantListAdapter extends ArrayAdapter<String> {

    private final Activity context;
    private final String[] itemname;
    private final Integer[] imgid;

    public AddRestaurantListAdapter(Activity context, String[] itemname, Integer[] imgid) {
